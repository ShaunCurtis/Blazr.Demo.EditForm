...
public record ValidationMessage(Guid ObjectUid, string Field, string Message) { }
...
public class ValidationMessageCollection : IEnumerable<ValidationMessage>
{
    ...
    public void Add(Guid objectUid, string field, string message)
        => _messages.Add(new ValidationMessage(objectUid, field, message));

    public void Add(Guid objectUid, string field, IEnumerable<string> messages)
    {
